...
class TrackingManager(
    ...
    private val emaX = AdaptiveEMAFilter(minAlpha = 0.15f, maxAlpha = 0.7f)
    private val emaY = AdaptiveEMAFilter(minAlpha = 0.15f, maxAlpha = 0.7f)
    private val deadbandX = IntelligentDeadband(threshold = 3.0f, hysteresis = 1.5f)
    private val deadbandY = IntelligentDeadband(threshold = 3.0f, hysteresis = 1.5f)
